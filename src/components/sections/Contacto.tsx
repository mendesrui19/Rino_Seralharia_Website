            ...
            <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 mb-6">
              ...
              <div className="flex flex-col sm:flex-row xl:flex-col gap-3 shrink-0">
                <div className="relative group w-full sm:w-auto">
                  <button className="btn btn-wa text-[0.8rem] py-2.5 px-5 flex items-center justify-center w-full">
                    ...
                    Enviar WhatsApp
                    <svg className="w-3 h-3 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
                  </button>
                  <div className="absolute top-full left-0 right-0 mt-2 bg-[#1a1a1a] border border-white/10 rounded-md shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 flex flex-col overflow-hidden">
                    <a href="https://wa.me/351913255102?text=Olá,%20gostaria%20de%20pedir%20um%20orçamento" target="_blank" className="px-4 py-3 hover:bg-white/5 text-[0.8rem] flex justify-between items-center transition-colors">
                      <span className="font-medium">Geral</span>
                      <span className="text-dim text-[0.7rem]">913 255 102</span>
                    </a>
                    <a href="https://wa.me/351913148995?text=Olá,%20gostaria%20de%20pedir%20um%20orçamento" target="_blank" className="px-4 py-3 hover:bg-white/5 text-[0.8rem] flex justify-between items-center transition-colors border-t border-white/5">
                      <span className="font-medium">Sr. Nelson</span>
                      <span className="text-dim text-[0.7rem]">913 148 995</span>
                    </a>
                  </div>
                </div>
